...
class AddInvSupply extends Migration
{
    public function up()
    {
        $this->forge->addField([
        ...
        $this->forge->addField('CONSTRAINT FOREIGN KEY (supplier) REFERENCES wp_users(ID)');

        $this->forge->addKey('id', true);
        $this->forge->createTable('ven_inv_supply');
    }

    public function down()
    {
        $this->forge->dropTable('ven_inv_supply');
    }
}