...
<html>
<head>
	<title>Call Center Bot with Agent Assististant</title>
...
<body>
	<h1 style="text-align:  left">Call Center Bot with Agent Assistant</h1>
	...
	<div style="float: left;margin-left: 50px;">
		<div id="conversation1" style="width: 400px; height: 400px; border: 1px solid #ccc; background-color: rgb(228, 225, 227); padding: 4px; overflow: scroll"></div>
	...
	<script type="text/javascript">
        ...
        egionAWS.config.credentials = new AWS.CognitoIdentityCredentials({ 
		...
		function pushChat() {
			...
			if(inputText && inputText.value && inputText.value.trim().length > 0 && inputText.value[0]=='C') {
				...
				var params = {
					botAlias: '$LATEST',
					botName: 'Enter the name of your bot',
